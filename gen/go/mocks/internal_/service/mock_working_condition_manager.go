...
// CreateWorkingCondition provides a mock function with given fields: ctx, read, in
func (_m *MockWorkingConditionManager) CreateWorkingCondition(ctx context.Context, read *options.Read, in *model.WorkingCondition) (*model.WorkingCondition, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *options.Read, *model.WorkingCondition) (*model.WorkingCondition, error)); ok {
		return rf(ctx, read, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *options.Read, *model.WorkingCondition) *model.WorkingCondition); ok {
		r0 = rf(ctx, read, in)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *options.Read, *model.WorkingCondition) error); ok {
		r1 = rf(ctx, read, in)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockWorkingConditionManager_Expecter) CreateWorkingCondition(ctx interface{}, read interface{}, in interface{}) *MockWorkingConditionManager_CreateWorkingCondition_Call {
	return &MockWorkingConditionManager_CreateWorkingCondition_Call{Call: _e.mock.On("CreateWorkingCondition", ctx, read, in)}
}

func (_c *MockWorkingConditionManager_CreateWorkingCondition_Call) Run(run func(ctx context.Context, read *options.Read, in *model.WorkingCondition)) *MockWorkingConditionManager_CreateWorkingCondition_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*options.Read), args[2].(*model.WorkingCondition))
	})
	return _c
}

func (_c *MockWorkingConditionManager_CreateWorkingCondition_Call) Return(_a0 *model.WorkingCondition, _a1 error) *MockWorkingConditionManager_CreateWorkingCondition_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWorkingConditionManager_CreateWorkingCondition_Call) RunAndReturn(run func(context.Context, *options.Read, *model.WorkingCondition) (*model.WorkingCondition, error)) *MockWorkingConditionManager_CreateWorkingCondition_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockWorkingConditionManager) SearchWorkingCondition(ctx context.Context, search *options.Search) ([]*model.WorkingCondition, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *options.Search) ([]*model.WorkingCondition, bool, error)); ok {
...
func (_c *MockWorkingConditionManager_SearchWorkingCondition_Call) Return(_a0 []*model.WorkingCondition, _a1 bool, _a2 error) *MockWorkingConditionManager_SearchWorkingCondition_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockWorkingConditionManager_SearchWorkingCondition_Call) RunAndReturn(run func(context.Context, *options.Search) ([]*model.WorkingCondition, bool, error)) *MockWorkingConditionManager_SearchWorkingCondition_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateWorkingCondition provides a mock function with given fields: ctx, read, in
func (_m *MockWorkingConditionManager) UpdateWorkingCondition(ctx context.Context, read *options.Read, in *model.WorkingCondition) (*model.WorkingCondition, error) {
	ret := _m.Called(ctx, read, in)
...
//   - read *options.Read
//   - in *model.WorkingCondition
func (_e *MockWorkingConditionManager_Expecter) UpdateWorkingCondition(ctx interface{}, read interface{}, in interface{}) *MockWorkingConditionManager_UpdateWorkingCondition_Call {
	return &MockWorkingConditionManager_UpdateWorkingCondition_Call{Call: _e.mock.On("UpdateWorkingCondition", ctx, read, in)}
}

func (_c *MockWorkingConditionManager_UpdateWorkingCondition_Call) Run(run func(ctx context.Context, read *options.Read, in *model.WorkingCondition)) *MockWorkingConditionManager_UpdateWorkingCondition_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*options.Read), args[2].(*model.WorkingCondition))
	})
	return _c
...
func (_c *MockWorkingConditionManager_UpdateWorkingCondition_Call) Return(_a0 *model.WorkingCondition, _a1 error) *MockWorkingConditionManager_UpdateWorkingCondition_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWorkingConditionManager_UpdateWorkingCondition_Call) RunAndReturn(run func(context.Context, *options.Read, *model.WorkingCondition) (*model.WorkingCondition, error)) *MockWorkingConditionManager_UpdateWorkingCondition_Call {
	_c.Call.Return(run)
	return _c
}
