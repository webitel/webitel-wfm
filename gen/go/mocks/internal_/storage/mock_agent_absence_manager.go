...
func (_m *MockAgentAbsenceManager) CreateAgentAbsence(ctx context.Context, read *options.Read, in *model.Absence) (int64, error) {
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *options.Read, *model.Absence) (int64, error)); ok {
		return rf(ctx, read, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *options.Read, *model.Absence) int64); ok {
		r0 = rf(ctx, read, in)
	} else {
		r0 = ret.Get(0).(int64)
	}
...
func (_c *MockAgentAbsenceManager_CreateAgentAbsence_Call) Return(_a0 int64, _a1 error) *MockAgentAbsenceManager_CreateAgentAbsence_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAgentAbsenceManager_CreateAgentAbsence_Call) RunAndReturn(run func(context.Context, *options.Read, *model.Absence) (int64, error)) *MockAgentAbsenceManager_CreateAgentAbsence_Call {
	_c.Call.Return(run)
	return _c
}

// CreateAgentsAbsences provides a mock function with given fields: ctx, search, in
func (_m *MockAgentAbsenceManager) CreateAgentsAbsences(ctx context.Context, search *options.Search, in []*model.AgentAbsences) ([]int64, error) {
	...
	var r0 []int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *options.Search, []*model.AgentAbsences) ([]int64, error)); ok {
		return rf(ctx, search, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *options.Search, []*model.AgentAbsences) []int64); ok {
		r0 = rf(ctx, search, in)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]int64)
...
func (_c *MockAgentAbsenceManager_CreateAgentsAbsences_Call) Return(_a0 []int64, _a1 error) *MockAgentAbsenceManager_CreateAgentsAbsences_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAgentAbsenceManager_CreateAgentsAbsences_Call) RunAndReturn(run func(context.Context, *options.Search, []*model.AgentAbsences) ([]int64, error)) *MockAgentAbsenceManager_CreateAgentsAbsences_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAgentAbsenceManager) SearchAgentsAbsences(ctx context.Context, search *options.Search) ([]*model.AgentAbsences, error) {
	ret := _m.Called(ctx, search)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *options.Search) ([]*model.AgentAbsences, error)); ok {
		return rf(ctx, search)
	}
...
func (_c *MockAgentAbsenceManager_SearchAgentsAbsences_Call) Return(_a0 []*model.AgentAbsences, _a1 error) *MockAgentAbsenceManager_SearchAgentsAbsences_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAgentAbsenceManager_SearchAgentsAbsences_Call) RunAndReturn(run func(context.Context, *options.Search) ([]*model.AgentAbsences, error)) *MockAgentAbsenceManager_SearchAgentsAbsences_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateAgentAbsence provides a mock function with given fields: ctx, read, in
func (_m *MockAgentAbsenceManager) UpdateAgentAbsence(ctx context.Context, read *options.Read, in *model.Absence) error {
	ret := _m.Called(ctx, read, in)
...
func (_c *MockAgentAbsenceManager_UpdateAgentAbsence_Call) Return(_a0 error) *MockAgentAbsenceManager_UpdateAgentAbsence_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAgentAbsenceManager_UpdateAgentAbsence_Call) RunAndReturn(run func(context.Context, *options.Read, *model.Absence) error) *MockAgentAbsenceManager_UpdateAgentAbsence_Call {
	_c.Call.Return(run)
	return _c
}
