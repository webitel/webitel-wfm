...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20251009095601-21947ef4e219.2
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.1-20251009095601-21947ef4e219.1
