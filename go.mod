...
require (
	...
	buf.build/gen/go/webitel/engine/grpc/go v1.5.1-20251030120059-ca152170d112.2
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.1-20251030120059-ca152170d112.1
