...
require (
	...
	github.com/webitel/webitel-go-kit v0.0.18
	github.com/webitel/webitel-go-kit/logging/wlog v0.0.0-20240920170517-9e09828499ac
...
require (
	...
	buf.build/gen/go/webitel/webitel-go/grpc/go v1.5.1-20240725111140-8ade8003e454.1 // indirect
